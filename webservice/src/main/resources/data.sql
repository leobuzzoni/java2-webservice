...
ALTER TABLE EMPRESA ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM EMPRESA);
ALTER TABLE ESTUDANTE ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM ESTUDANTE);
ALTER TABLE VAGA ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM VAGA);
ALTER TABLE AREA ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM AREA);
ALTER TABLE INSCRICAO ALTER COLUMN ID RESTART WITH (SELECT MAX(ID) + 1 FROM INSCRICAO);

-- ALTER TABLE EMPRESA ALTER COLUMN ID RESTART WITH 6;
-- ALTER TABLE ESTUDANTE ALTER COLUMN ID RESTART WITH 11;
-- ALTER TABLE VAGA ALTER COLUMN ID RESTART WITH 8;
-- ALTER TABLE AREA ALTER COLUMN ID RESTART WITH 6;
-- ALTER TABLE INSCRICAO ALTER COLUMN ID RESTART WITH 6;